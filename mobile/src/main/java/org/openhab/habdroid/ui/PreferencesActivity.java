...
public class PreferencesActivity extends AppCompatActivity {
    ...
    public abstract static class AbstractSettingsFragment extends PreferenceFragment {
         ...
         */
        protected PreferenceGroup getParent(Preference preference) {
         ...
         * @author https://stackoverflow.com/a/17633389
         */
        protected PreferenceGroup getParent(PreferenceGroup root, Preference preference) {
    ...
    public static class MainSettingsFragment extends AbstractSettingsFragment {
        ...
        protected void updateAndInitPreferences() {
            ...
            final Preference screenLockPref = findPreference(PREFERENCE_SCREENLOCK);
            final Preference preventScreenshotPref = findPreference(PREFERENCE_PREVENT_SCREENSHOTS);
